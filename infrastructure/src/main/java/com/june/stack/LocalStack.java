...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        FargateService authService = createFargateService("AuthService", "auth-service",
                List.of(4006),
                authServiceDB,
                Map.of("JWT_SECRET", "K7gNU3sdo+OL0wNhqoVWhr3g6s1xYv72ol/pe/Unols="));
        ...
        authService.getNode().addDependency(patientServiceDBHealthCheck);
        authService.getNode().addDependency(patientServiceDB);
        authService.getNode().addDependency(billingService);
    ...
    private void createApiGatewayService() {
        ...
        ContainerDefinitionOptions containerOptions =
                ContainerDefinitionOptions.builder()
                        .image(ContainerImage.fromRegistry("api_gateway"))
                        .environment(Map.of("SPRING_PROFILES_ACTIVE", "prod",
                                "AUTH_SERVICE_URL", "http://host.docker.internal:4006"))
    ...
    public static void main(final String[] args) {
        ...
        app.synth();
        System.out.println("cdk synth in progress...");
    }
}
